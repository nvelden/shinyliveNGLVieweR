...
| 9 | Pages-ready build (clean staged) | chromium | 1280x900 | shinylive default | n/a | n/a | <60s | 23.76 | 119M / 114M / 111M | docs/ built from a staged clean copy (app.R + R/ + www/). app.json shrank from 209 MB → 5.3 MB by excluding node_modules / test-results / playwright-report. Local smoke green. Production URL row to follow once Pages is enabled. |
